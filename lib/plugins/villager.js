...
function inject(bot, { version }) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (!bot.supportFeature("setSlotAsTransaction")) {
                ...
                if (slot1) {
                    ...
                    const updatedSlot1 = updatedCount1 <= 0 ? null : { ...slot1, count: updatedCount1 }
                ...
                if (slot2) {
                    ...
                    const updatedSlot2 = updatedCount2 <= 0 ? null : { ...slot2, count: updatedCount2 }
    ...
    async function putRequirements(window, Trade) {
        ...
        const input1 = slot1 ? Math.max(0, Trade.realPrice - slot1.count) : Trade.realPrice
        if (input1) {
        ...
        if (Trade.hasItem2) {
            ...
            const input2 = slot2 ? Math.max(0, tradeCount2 - slot2.count) : tradeCount2
            if (input2) {
