...
bot.on("physicsTick", () => {
    ...
    const filter = (e) => e.type === "mob" && e.position.distanceTo(bot.entity.position) < 16 && e.displayName !== "Armor Stand" // Mojang classifies armor stands as mobs for some reason?
